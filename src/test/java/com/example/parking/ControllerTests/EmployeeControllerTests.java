...
public class EmployeeControllerTests {
		...
		ObjectMapper objectMapper;
			...
			{
				//given
				when(employeeService.authenticate("manasa@gmail.com", "1234")).thenReturn("login success");
			...
			{
				//given
				when(employeeService.authenticate("manasa@gmail.com", "1234")).thenReturn("invalid");
